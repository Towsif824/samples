...
namespace Final_Project_APWDN_SMS.Repository
{
    public class GradeRepository:Repository<Grade>, IGradeRepository
    {
        ...
        public Grade GetGradeBySectionsBySubjects(int id, int id2, int id3)
        {
            return this.data.Grades.Where(x => x.sectionid == id && x.studentid == id2 && x.gradeid == id3).FirstOrDefault();
        }
    }
}